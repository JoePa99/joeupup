...
export function GoogleOAuthButton({ 
  ...
  const handleGoogleOAuth = async () => {
    ...
    try {
      // Define the scopes we need for G Suite integration
      const scopes = [
      ...
      const googleClientId = "319352434470-r28thsev17e48nhcn1nrkcgiuc8d0us2.apps.googleusercontent.com";
      ...
      authUrl.searchParams.append('state', 'sync'); // Include sync flag

      console.log('OAuth URL:', authUrl.toString());

      // Use redirect approach to avoid COOP issues
